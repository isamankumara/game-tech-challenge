...
const init: IGame = {
    ...
    playerTwo: { name: "Player 1", point: 0, selection: "", playerType: PlayerType.PlayerTwo, displaySelection: true },
    message: "",
    status: 0,
};
describe("Game Slice testing", () => {
    test("test the player selection and stop useriteraction", () => {
        expect(authSlice.reducer(init, gameSlice.actions.userSelection({ selection: "rock", player: init.playerOne }))).toEqual({
            ...
            currentPlayer: CurrentPlayer.PlayerOne,
            winningPlayer: null,
            playerOne: { name: "You", point: 0, selection: "rock", playerType: PlayerType.PlayerOne, displaySelection: true },
            playerTwo: { name: "Player 1", point: 0, selection: "", playerType: PlayerType.PlayerTwo, displaySelection: true },
            message: "",
            status: 0,
        });
    ...
    test("test the player selection with player 2", () => {
        expect(authSlice.reducer(init, gameSlice.actions.userSelection({ selection: "rock", player: init.playerTwo }))).toEqual({
            ...
            winningPlayer: null,
            playerOne: { name: "You", point: 0, selection: "", playerType: PlayerType.PlayerOne, displaySelection: true },
            playerTwo: { name: "Player 1", point: 0, selection: "rock", playerType: PlayerType.PlayerTwo, displaySelection: true },
            message: "",
            status: 0,
        });
    });
    ...
    test("test the tie", () => {
        expect(
            authSlice.reducer(
                {
                    ...
                    winningPlayer: null,
                    playerOne: { name: "You", point: 0, selection: "rock", playerType: PlayerType.PlayerOne, displaySelection: true },
                    playerTwo: { name: "Player 1", point: 1, selection: "rock", playerType: PlayerType.PlayerTwo, displaySelection: true },
                    message: "",
                    status: 0,
                },
            ...
            winningPlayer: null,
            playerOne: { name: "You", point: 0, selection: "", playerType: PlayerType.PlayerOne, displaySelection: true },
            playerTwo: { name: "Player 1", point: 1, selection: "", playerType: PlayerType.PlayerTwo, displaySelection: true },
            message: "Tie",
            status: 0,
        });
    });
    ...
    test("test check  rock and paper", () => {
        expect(
            authSlice.reducer(
                {
                    ...
                    currentPlayer: CurrentPlayer.PlayerOne,
                    winningPlayer: null,
                    playerOne: { name: "You", point: 0, selection: "paper", playerType: PlayerType.PlayerOne, displaySelection: true },
                    playerTwo: { name: "Player 1", point: 1, selection: "rock", playerType: PlayerType.PlayerTwo, displaySelection: true },
                    message: "",
                    status: 0,
                },
            ...
            currentPlayer: CurrentPlayer.PlayerOne,
            winningPlayer: null,
            playerOne: { name: "You", point: 1, selection: "", playerType: PlayerType.PlayerOne, displaySelection: true },
            playerTwo: { name: "Player 1", point: 1, selection: "", playerType: PlayerType.PlayerTwo, displaySelection: true },
            message: "You: Winner",
            status: 0,
        });
    ...
    test("test check paper and rock", () => {
        expect(
            authSlice.reducer(
                {
                    ...
                    winningPlayer: null,
                    playerOne: { name: "You", point: 0, selection: "rock", playerType: PlayerType.PlayerOne, displaySelection: true },
                    playerTwo: { name: "Player 1", point: 1, selection: "paper", playerType: PlayerType.PlayerTwo, displaySelection: true },
                    message: "",
                    status: 0,
                },
                gameSlice.actions.checkWinnerWithReset({})
            ...
            winningPlayer: null,
            playerOne: { name: "You", point: 0, selection: "", playerType: PlayerType.PlayerOne, displaySelection: true },
            playerTwo: { name: "Player 1", point: 2, selection: "", playerType: PlayerType.PlayerTwo, displaySelection: true },
            ...
            authSlice.reducer(
                {
                    ...
                    mode: GameMode.UserToComputer,
                    currentPlayer: CurrentPlayer.PlayerOne,
                    winningPlayer: { name: "Player 1", point: 1, selection: "paper", playerType: PlayerType.PlayerTwo, displaySelection: true },
                    playerOne: { name: "You", point: 0, selection: "rock", playerType: PlayerType.PlayerOne, displaySelection: true },
                    playerTwo: { name: "Player 1", point: 1, selection: "paper", playerType: PlayerType.PlayerTwo, displaySelection: true },
    ...
    test("test after change game mode computer to computer ", () => {
        expect(authSlice.reducer(init, gameSlice.actions.changeGameMode({ mode: GameMode.ComputerToComputer }))).toEqual({
            ...
            currentPlayer: CurrentPlayer.PlayerOne,
            winningPlayer: null,
            playerOne: { name: "Player 1", point: 0, selection: "", playerType: PlayerType.PlayerOne, displaySelection: true },
            playerTwo: { name: "Player 2", point: 0, selection: "", playerType: PlayerType.PlayerTwo, displaySelection: true },
            message: "",
            status: 0,
        });
    });
